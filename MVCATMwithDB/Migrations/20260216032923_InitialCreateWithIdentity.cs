        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Transaction_Status", "[Status] IN ('Success', 'Failed')");
                    table.CheckConstraint("CK_Transaction_Type", "[TransactionType] IN ('Withdrawal', 'Deposit', 'BalanceInquiry')");
                    table.ForeignKey(
